...
SPEC 2.1: six skills maintained by hand across seven repositories. This command
finds the override pattern already inside those duplicated files, classifies
every divergent block, and reports conflicts without resolving any.
